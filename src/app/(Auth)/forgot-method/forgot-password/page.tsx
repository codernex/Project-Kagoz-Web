...
const Page = () => {
    ...
    return (
        <div className=" flex items-center justify-center font-inter my-[120px] md:px-0 px-6">
            <div className="lg:max-w-[942px] w-full place-items-center grid md:grid-cols-2 grid-cols-1 gap-[56px] bg-white rounded-2xl ">
                {/* Left side */}
                <div className="relative hidden md:flex items-center justify-center  pl-7 mx-1.5">
                    {/* Background gradient image */}
                   <div className="absolute -left-[5.5rem] bottom-7  inset-0 flex items-center justify-center ">
                               <Image
                        ...
                        <div className="text-center">
                            ...
                            <ul className="text-left space-y-4 text-gray-700">
                                <li className="flex items-center text-[14px] ">
                                    <Shield className="w-[16px] h-[16px] text-[#6F00FF] mr-2" />
                                    Secure password reset process
                                </li>
                                <li className="flex items-center text-[14px] ">
                                    <Mail className="w-[16px] h-[16px] text-[#6F00FF] mr-2" />
                                    Link expires in 5 minutes
                                </li>
                                <li className="flex items-center text-[14px] ">
                                    <CheckCircle className="w-[16px] h-[16px] text-[#6F00FF] mr-2" />
                ...
                <div className="p-8 rounded-[16px] bg-white authform-shadow w-full">
                    <Link href="/signin" className="common-text  !font-normal text-[#111827] flex items-center mb-[23px]">
                        <ArrowLeft className="w-[16px] h-[16px] mr-1" /> Back to Sign In
                    </Link>
