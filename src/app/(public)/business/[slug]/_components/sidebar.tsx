  ...
  return (
    <div className=" bg-white px-[2.4rem] py-[3rem] rounded-smd drop-shadow-md">
      ...
      <div className="p-[2.4rem] rounded-smd bg-[#6E677708] border border-[#6E677726] mt-[1.6rem] space-y-[1.6rem] ">
        {
          data?.website && (
            <Link rel="nofollow" href={data.website} className="flex items-center p-[2rem] justify-between bg-[#6E67770D] border-none text-primary rounded-xl font-medium">
        ...
        <Link href={'tel:' + data?.mobile || '01888 xxx xxx'} onMouseOver={() => {
        ...
        <div className="flex justify-center gap-x-[2rem]">
          {
            data?.facebook ? <Link target="_blank" rel="nofollow" href={data.facebook}>
              <svg
                width="46"
                height="46"
                viewBox="0 0 46 46"
          ...
          {
            data?.youtube ? <Link target="_blank" rel="nofollow" href={data.youtube}>
              <svg
                width="46"
                height="46"
                viewBox="0 0 46 46"
